      ...
      <section>
        ...
        <div>
          <button
            ...
            id='show-visor'
            style={{ margin: "10px" }}>
            Load Tensorflow Visor
          </button>
        </div>
        <span>
          <ul>
            <li>
              <strong>`</strong> (backtick): Shows or hides the visor
            </li>
            <li>
              <strong>~</strong> (tilde, shift+backtick): Toggles betweeen the
              two sizes the visor supports
            </li>
          </ul>
        </span>
        <span>
        ...
        <div>
          <button
            onClick={() => this.surface()}
            id='make-surface'
            style={{ margin: "10px" }}
            disabled={this.state.disabled_surface}>
            Make a surface
          </button>
        </div>
        <span>
        ...
        <div>
          ...
          <button
            onClick={() => this.example_button()}
            id='example-button'
            style={{ margin: "10px" }}
            disabled={this.state.disabled_examples}>
            Show Data Examples
          </button>
        </div>
        <h3>Train Model</h3>
        ...
        <div>
          <button
            onClick={() => this.show_train()}
            id='start-training'
            style={{ margin: "10px" }}
            disabled={this.state.disabled_train}>
            Train Model
            <PacmanLoader
              className='sweet-loading'
              css={override}
        ...
        <div>
          <button
            onClick={() => this.showAccuracy()}
            id='show-accuracy'
            style={{ margin: "10px" }}
            disabled={this.state.disabled_test}>
            Test Model
          </button>
          <button
            onClick={() => this.showConfusion()}
            id='show-confusion'
            style={{ margin: "10px" }}
            disabled={this.state.disabled_confusion}>
            Draw Confusion
          </button>
        </div>
      </section>
